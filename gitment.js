...
function renderComments(_ref2, instance) {
  ...
  if (error) {
    ...
    emptyBlock.innerText = '暂无评论，发表您的看法吧';
  ...
  comments.forEach(function (comment) {
    var createDate = new Date(comment.created_at).Format("yyyy-MM-dd HH:mm:ss");
    var updateDate = new Date(comment.updated_at).Format("yyyy-MM-dd HH:mm:ss");
